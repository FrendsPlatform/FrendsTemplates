This process will read a **CSV** file which contains key-value pairs representing the data to be insert into the **MicrosoftSQL database** from an **SFTP server**. 
